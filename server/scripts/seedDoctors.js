...
const seedDoctors = async () => {
  try {
    ...
    console.log('Existing doctors count:', existingDoctors);
    
    if (existingDoctors > 0) {
      console.log('Doctors already exist in the database. Clearing and re-seeding.');
    ...
    const insertResult = await Doctor.insertMany(sampleDoctors);
